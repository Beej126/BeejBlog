...
- CPU: [Intel Core i9-9900K](https://www.intel.com/content/www/us/en/products/processors/core/i9-processors/i9-9900k.html)
  - This is <span class="hl">8 core</span>, 9th gen Coffee Lake with built in HD 630 graphics. For my needs as a developer workstation, it's nice not to need to cram in a video card... a short one might just barely fit if needs arise, but I'd probably have to accept leaving at least one of the side panels off to ventilate.
- Cooler: [Corsair Hydro Series H80i v2](https://www.corsair.com/us/en/Categories/Products/Liquid-Cooling/Single-Radiator-Liquid-Coolers/Hydro-Series%E2%84%A2-H80i-v2-High-Performance-Liquid-CPU-Cooler/p/CW-9060024-WW)
  - admittedly this poor little 1U 120mm radiator is easily overwhelmed by the 9900K with OC but it's the largest cooling that can possibly squeeze into this small case size I'm drawn to... at least the radiator is double thick and the fans are configured in the optimal push+pull arrangement. 
